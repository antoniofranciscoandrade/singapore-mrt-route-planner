...
const getStartingStation = (startStation) => 
    startStation ? startStation : 'Choose starting station by clicking on the map...';
...
const ConnectedOriginDestinationLabel = connect(mapStateToProps)(OriginDestinationLabel);
